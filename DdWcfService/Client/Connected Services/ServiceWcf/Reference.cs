...
namespace Client.ServiceWcf {
    ...
    public interface IService1 {
        ...
        System.Collections.Generic.Dictionary<string, int> Create(string[] text);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Create", ReplyAction="http://tempuri.org/IService1/CreateResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<string, int>> CreateAsync(string[] text);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<Client.ServiceWcf.IService1>, Client.ServiceWcf.IService1 {
        ...
        public System.Collections.Generic.Dictionary<string, int> Create(string[] text) {
            return base.Channel.Create(text);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<string, int>> CreateAsync(string[] text) {
